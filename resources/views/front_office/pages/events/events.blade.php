...
@section('content')
    <section>
        <div class="feature-photo">
            <figure><img src="{{ asset('images/front_office_images/timeline-1.jpg') }}" alt="" /></figure>
            <div class="add-btn">
                <span>1205 followers</span>
                <a href="/events/create" title="" data-ripple="">Add Event</a>
            </div>
                ...
                <div class="row merged">
                    <div class="col-lg-2 col-sm-3">
                        <div class="user-avatar">
                            <figure>
                                <img src="{{ asset('images/front_office_images/user-avatar.jpg') }}" alt="" />
                                <form class="edit-phto">
                                    <i class="fa fa-camera-retro"></i>
                                    <label class="fileContainer">
                                        Edit Display Photo
                        ...
                        <div class="timeline-info">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a class="active" href="/events" title="" data-ripple="">Events</a>
